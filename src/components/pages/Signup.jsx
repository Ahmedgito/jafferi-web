...
const Form = () => {
    ...
    <h1 className='font-bold text-5xl mt-3 mb-1 md:mt-8 md:mb-2 text-black ms-auto text-center font-sans'></h1>
    <div className="relative py-3 sm:max-w-xl sm:mx-auto">    
      <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
      <h1 className='font-bold text-2xl text-[#003505] font-sans ms-auto text-center'>REGISTER NOW </h1>
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full focus:border-blue-500 focus:ring-2 focus:ring-blue-500" type="number" id="number" />
            </div>
            <div>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <a className="text-xs text-gray-500 uppercase dark:text-gray-800 cursor-default hover:underline" 
